...
export default function Login() {
  ...
  return (
    <div className='mb-5'>
        <Header/>
        <div className="container mt-5 col-10 col-xs-8 col-md-6 col-lg-8">
          <h1 className='pt-5 mb-3 text-center'>LOG IN</h1>
            <div className="mb-3 col-md-8 m-auto">
            ...
            <div className="mb-3 col-md-8 m-auto">
                ...
                <button className='btn btn-primaire d-block mt-4' onClick={login}>Log In</button>  
            </div>
        </div>
    </div>
  )
