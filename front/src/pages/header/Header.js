            ...
            <div className='d-flex justify-content-between align-items-center bg-white'>
                <div className="dropdown">
                    ...
                    <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        <li><a className="dropdown-item" href="http://localhost:3001">Action</a></li>
                        <li><a className="dropdown-item" href="http://localhost:3001">Another action</a></li>
                        <li><a className="dropdown-item" href="http://localhost:3001">Something else here</a></li>
                    </ul>
                </div>
